        ...
        <div class="max-w-6xl p-6 mx-auto mt-6 bg-slate-100">
            <form @submit.prevent="submit">
                <div class="mt-4">
                    ...
                    <TextInput id="name" type="text" class="block w-1/2 mt-1" v-model="form.name" required autofocus
                        autocomplete="name" />
                ...
                <div class="mt-4">
                    ...
                    <TextInput id="email" type="email" class="block w-1/2 mt-1" v-model="form.email" required
